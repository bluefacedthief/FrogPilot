...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self):
    ...
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 500000.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 500000.
    self._DISTRACTED_TIME = 500004. # active monitoring total timeout
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 500002.
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 500001.

    self._FACE_THRESHOLD = 0.5
    self._EYE_THRESHOLD = 0.45
    self._SG_THRESHOLD = 0.7
    self._BLINK_THRESHOLD = 0.665
